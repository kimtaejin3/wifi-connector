...
실제 앱 화면이어야 합니다 (6.9″: 1320×2868 또는 6.5″: 1284×2778, 최소 1장, 최대 10장).
권장 구성과 상단 문구:

1. 카메라 화면에 안내문을 비춘 모습 — "안내문을 비추면"
2. 결과 화면 (Wi-Fi를 찾았어요) — "이름과 비밀번호를 찾고"
3. iOS 연결 확인 알림 또는 "Wi-Fi에 연결되었습니다" — "바로 연결"
4. 기록 화면 — "다음엔 촬영 없이"
